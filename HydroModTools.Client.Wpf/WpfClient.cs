    ...
    public class WpfClient : ClientBase<Window>
    {
        ...
        public override void RegisterClientTypes(ContainerBuilder services)
        {
            ...
            var selectedTypes = types
                .Where(t => t.Name.EndsWith("View") || t.Name.EndsWith("Control") || t.Name.EndsWith("ViewModel") || t.Name.EndsWith("ControlModel"))
                .ToList();
        ...
        private class HMTApp : Application
        {
            ...
            public void InitializeComponent()
            {
                ...
                var resourceLocater = new Uri("/HydroModTools.Client.Wpf;component/app.xaml", UriKind.Relative);
