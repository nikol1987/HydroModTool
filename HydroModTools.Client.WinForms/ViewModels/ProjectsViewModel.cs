using HydroModTools.Client.Winforms.Views.ApplicationTabs.ProjectTabs;
...
namespace HydroModTools.Client.WinForms.ViewModels
{
    public sealed class ProjectsViewModel : ReactiveObject
    {
        ...
        public ProjectsViewModel(IServiceProvider services, IProjectsService projectsService, IConfigurationService configurationService)
        {
            ...
            _selectedProject = ApplicationStore.Store.DefaultProject ?? firstProject?.Id ?? Guid.Empty;
