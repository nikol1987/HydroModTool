...
{
    public sealed class MSTreeView : TreeView
    {
        public MSTreeView()
        {
            ...
            try
            {
                ...
                if (e.KeyCode == Keys.Left)
                {
                    ...
                    else if (m_SelectedNode.Parent != null)
                    {
                        ...
                        SelectSingleNode((TreeNode)m_SelectedNode.Parent);
                    }
                }
                else if (e.KeyCode == Keys.Right)
                {
                    ...
                    else
                    {
                        ...
                        SelectSingleNode((TreeNode)m_SelectedNode.FirstNode);
                    }
                }
                else if (e.KeyCode == Keys.Up)
                {
                    ...
                    {
                        SelectNode((TreeNode)m_SelectedNode.PrevVisibleNode);
                    }
                }
                else if (e.KeyCode == Keys.Down)
                {
                    ...
                    {
                        SelectNode((TreeNode)m_SelectedNode.NextVisibleNode);
                    }
                }
                else if (e.KeyCode == Keys.Home)
                {
                    if (bShift)
                    {
                        ...
                        else
                        {
                            ...
                            // this nodes parent
                            SelectNode((TreeNode)m_SelectedNode.Parent.FirstNode);
                        }
                    }
                    else
                    {
                ...
                else if (e.KeyCode == Keys.End)
                {
                    if (bShift)
                    {
                        ...
                        else
                        {
                            ...
                            SelectNode((TreeNode)m_SelectedNode.Parent.LastNode);
                        }
                    }
                    else
                    {
                        if (this.Nodes.Count > 0)
                        {
                            ...
                            SelectSingleNode((TreeNode)ndLast);
                        }
                    }
                }
                else if (e.KeyCode == Keys.PageUp)
                {
                    ...
                    SelectSingleNode((TreeNode)ndCurrent);
                }
